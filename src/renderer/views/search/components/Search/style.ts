...
export const SearchIcon = styled.div`
  ...
  ${({ isFocused }: { isFocused: any }) => css`
    background-image: url(${isFocused ? icons.search : GOOGLE_ICON});
  `}
`;
