...
LOCAL_INCLUDES += -I$(topsrcdir)/extensions/auth
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/base
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/cookie
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/dns
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/ipc
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/socket/neqo_glue
LOCAL_INCLUDES += -I$(topsrcdir)/netwerk/url-classifier
CPPSRCS += $(srcdir)/nsHttpChannelAuthProvider.cpp
CPPSRCS += $(srcdir)/nsHttpHandler.cpp
