...
themes-block-title = Themes
themes-block-description = Customise the look of your browser.

themes-block-get-more-themes = Get more themes

interface-block-title = Interface
interface-block-description = Fine-tune elements of the browser.

interface-block-page-zoom = Page zoom
interface-block-home-button = Show home button
interface-block-bookmarks-bar = Show bookmarks bar
interface-block-integrated-titlebar = Show integrated titlebar
interface-block-drag-space = Show window drag space

interface-block-font-size = Font size
interface-block-font-size-desc = The quick brown fox jumps over the lazy dog.
interface-block-font-size-small = Small
interface-block-font-size-medium = Medium (recommended)
interface-block-font-size-large = Large
interface-block-font-size-xlarge = Extra Large

interface-block-fonts = Fonts
interface-block-fonts-desc = Customise fonts...
